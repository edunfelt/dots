...
myStartupHook = do
    ...
    spawn     "feh --bg-fill /home/edun/Pictures/Wallpapers/iso.png &"
    ...
    spawnOnce "xsettingsd -c ~/.config/xsettingsd/solarized-dark.conf &"
    setWMName "LG3D"
...
-- General -------------------------------------------------------------------------------
    ...
    , ("M-p", spawn "dmenu_run -nf '#eee8d5' -nb '#586e75' -sb '#2aa198' -sf '#fdf6e3' -fn 'BlexMono Nerd Font:pixelsize=13'")
...
-- Keypad ---------------------------------------------------------------------------------
    ...
    , ("<KP_Down>", focusDown)
    , ("<KP_Begin>", nextScreen)
    , ("<KP_Enter>", spawn "dmenu_run -nf '#eee8d5' -nb '#586e75' -sb '#2aa198' -sf '#fdf6e3' -fn 'BlexMono Nerd Font:pixelsize=13'")
