...
-- Theme ----------------------------------------------------------------------------------
myFont :: [Char]
myFont                      = "xft:BlexMono Nerd Font:pixelsize=13:antialias=true:hinting=true,FontAwesome:pixelsize=14"
...
wsPP           = xmobarPP { ppOrder               = id
                          ...
                          , ppCurrent             = xmobarColor   purple "" . wrap "@" ""
...
myProjects = [Project -- uni
                ...
                , projectDirectory = "~/Documents/10-19_Education/14_Masters_Degree"
            ...
            , Project -- wrk
                ...
                , projectDirectory = "~/Documents/20-29_Work/22_TA/22.04_Programmeringsteknik"
                , projectStartHook = Just $ do
                    spawnOn (myWorkspaces !! 2) (myTerminal ++ " -e fff ~/Documents/20-29_Work/22_TA")
                }
             , Project -- net
...
myStartupHook = do
    ...
    spawn     "feh --bg-fill /home/edun/Pictures/stranger.png &"
    ...
    spawnOnce "xsettingsd -c ~/.config/xsettingsd/twilight.conf &"
    setWMName "LG3D"
...
treeActions = [ Node (TS.TSNode "Session" "" (return ()))
             ...
             , Node (TS.TSNode "Productivity" "" (return ()))
              ...
              , Node (TS.TSNode "Communication" "" (return ()))
                     ...
                     , Node (TS.TSNode "Claws Mail" "Old school email client" (spawn "claws-mail")) []
...
tsConfig = TS.TSConfig
    ...
    , TS.ts_font           = myFont
    , TS.ts_background     = 0xff464b50
    , TS.ts_node           = (0xffa7a7a7, 0xff464b50)
    , TS.ts_nodealt        = (0xffa7a7a7, 0xff464b50)
    , TS.ts_highlight      = (0xffa7a7a7, 0xff7585a6)
    , TS.ts_extra          = 0xffafc4db
...
-- General -------------------------------------------------------------------------------
    ...
    , ("M-p", spawn "dmenu_run -nf '#a7a7a7' -nb '#464b50' -sb '#cf6a4c' -sf '#ffffff' -fn 'BlexMono Nerd Font:pixelsize=13'")
...
-- Keypad ---------------------------------------------------------------------------------
    ...
    , ("<KP_Down>", focusDown)
    , ("<KP_Begin>", nextScreen)
    , ("<KP_Enter>", spawn "dmenu_run -nf '#a7a7a7' -nb '#464b50' -sb '#cf6a4c' -sf '#ffffff' -fn 'BlexMono Nerd Font:pixelsize=13'")
