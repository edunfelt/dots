            ...
            , Project -- wrk
             ...
             , Project -- com
                 ...
                 , projectStartHook = Just $ do
                    ...
                    spawnOn (myWorkspaces !! 4) "claws-mail"
                 }
             , Project -- mul
...
myStartupHook = do
    ...
    spawn     "feh --bg-fill /home/edun/Pictures/Wallpapers/ghosts.jpg &"
    ...
    spawnOnce "xsettingsd -c ~/.config/xsettingsd/solarized-light.conf &"
    setWMName "LG3D"
...
-- General -------------------------------------------------------------------------------
    ...
    , ("M-p", spawn "dmenu_run -nf '#839496' -nb '#eee8d5' -sb '#2aa198' -sf '#fdf6e3' -fn 'BlexMono Nerd Font:pixelsize=13'")
...
-- Keypad ---------------------------------------------------------------------------------
    ...
    , ("<KP_Down>", focusDown)
    , ("<KP_Begin>", nextScreen)
    , ("<KP_Enter>", spawn "dmenu_run -nf '#839496' -nb '#eee8d5' -sb '#2aa198' -sf '#fdf6e3' -fn 'BlexMono Nerd Font:pixelsize=13'")
